...
parser.add_argument("--pdb", default="rebuilt_structure.pdb")
parser.add_argument("--outprefix", default="cgtriple300K")
...
torsion_params = [
    ("HBP", "BBP", "BBG", "HBG", 1, 2.0944, 1.5),
    ("HBG", "BBG", "BBP", "HBP", 1, -2.0944, 1.5)
]

# Build bonds inside each chain
    ...
    for i, res in enumerate(residues):
        ...
        for (a1, a2), (length, k) in bond_params.items():
            if a1 in atoms and a2 in atoms:
                bond_force.addBond(atoms[a1], atoms[a2], length * unit.nanometer, k * unit.kilojoule_per_mole / unit.nanometer**2)
...
force_bb.setCutoffDistance(1.225 * unit.nanometer)
...
epsilon_hbda[3,4] = 163.8  
sigma_hbda[3,4]   = 0.3
epsilon_hbda[4,3] = 163.8   
sigma_hbda[4,3]   = 0.3
