...
parser.add_argument("--pdb", default="POG12_1trimervs3.pdb")
parser.add_argument("--outprefix", default="POG12_300K")
...
torsion_params = [
    ("HBP", "BBP", "BBG", "HBG", 1, 2.0944, 15),
    ("HBG", "BBG", "BBP", "HBP", 1, -2.0944, 15)
]
...
epsilon_hbda[3,4] = 240
sigma_hbda[3,4]   = 0.3
epsilon_hbda[4,3] = 240
sigma_hbda[4,3]   = 0.3
